...
class TestSshConfig(unittest.TestCase):
    ...
    def test_config_full_cycle(self):
        ...
        ssh_config.config_files.add_to_configuration(foobar_config)
        self.assertTrue(test_path.exists())

        loaded_config = ssh_config.config_files.load_configuration_file()
        self.assertTrue(foobar_config in loaded_config)
        self.assertTrue(baz_config not in loaded_config)

        ssh_config.config_files.add_to_configuration(baz_config)
